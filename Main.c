...
#pragma config(Motor,  port2,           conv,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           LLaunch,       tmotorVex393TurboSpeed_MC29, openLoop, driveLeft)
#pragma config(Motor,  port4,           RLaunch,       tmotorVex393TurboSpeed_MC29, openLoop, driveRight)
